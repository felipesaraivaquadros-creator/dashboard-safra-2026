...
const SOJA2526_CONFIG: SafraConfig = {
  ...
  VOLUMES_CONTRATADOS: {
    ...
    "COMISSAO-FIXAR": { nome: "Comissões a Fixar", total: 1000 },
...
const SOJA2425_CONFIG: SafraConfig = {
  ...
  VOLUMES_CONTRATADOS: {
    ...
    "ILDO-AMAGGI": { nome: "Venda Amaggi Ildo (Total)", total: 19042 },
...
const MILHO25_CONFIG: SafraConfig = {
  ...
  VOLUMES_CONTRATADOS: {
    ...
    "21960": { nome: "Venda Inpasa (21960)", total: 60000 },
    ...
    "GRAO-DIRETO-AM": { nome: "Venda Grão Direto Amaggi Matupá", total: 10050 },
    "COOP-LRV": { nome: "Venda Cooperativa Sipal LRV", total: 21173 },
