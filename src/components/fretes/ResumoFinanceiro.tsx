...
import { Wallet, TrendingUp, TrendingDown, ArrowRight, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <section className="bg-white dark:bg-slate-800 rounded-[32px] border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden print:shadow-none print:border-t-2 print:border-b-2 print:border-slate-900 print:rounded-none print:mt-10">
      <div className="p-6 md:p-8">
        <div className="flex items-center gap-3 mb-8 print:mb-6">
          ...
          <div>
            <h2 className="text-xl font-black uppercase italic tracking-tighter text-slate-800 dark:text-white">Resumo do Fechamento</h2>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Consolidado Financeiro</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          {/* Coluna 1: Ganhos */}
          <div className="p-6 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-700 flex flex-col justify-between print:bg-white print:border-none print:p-0">
          ...
          <div className={`p-6 rounded-2xl border-2 flex flex-col justify-between shadow-sm print:bg-white print:border-none print:p-0 ${isCredor ? 'bg-green-50 border-green-200 dark:bg-green-900/10 dark:border-green-900/30' : 'bg-red-50 border-red-200 dark:bg-red-900/10 dark:border-red-900/30'}`}>
            ...
            <p className={`text-3xl font-black tracking-tighter ${isCredor ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'}`}>
