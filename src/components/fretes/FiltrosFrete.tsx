    ...
    <section className="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
        ...
        <div className="space-y-1.5">
          ...
          <select value={placaFiltro} onChange={(e) => setPlacaFiltro(e.target.value)} className="w-full bg-slate-50 dark:bg-slate-900 border-none rounded-xl px-4 py-2.5 text-xs font-bold focus:ring-2 focus:ring-purple-500 transition-all">
        ...
        <div className="space-y-1.5">
          ...
          <select value={armazemFiltro} onChange={(e) => setArmazemFiltro(e.target.value)} className="w-full bg-slate-50 dark:bg-slate-900 border-none rounded-xl px-4 py-2.5 text-xs font-bold focus:ring-2 focus:ring-purple-500 transition-all">
        ...
        <div className="space-y-1.5">
          ...
          <select value={tipoCalculo} onChange={(e) => setTipoCalculo(e.target.value as 'com' | 'sem')} className="w-full bg-slate-50 dark:bg-slate-900 border-none rounded-xl px-4 py-2.5 text-xs font-bold focus:ring-2 focus:ring-purple-500 transition-all">
