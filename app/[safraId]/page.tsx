        ...
        <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto">
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              ...
              {armazemFiltro && <span style={{backgroundColor: getCorArmazem(armazemFiltro)}} className="text-[9px] md:text-[10px] text-white px-2 py-0.5 rounded font-bold uppercase">{armazemFiltro}</span>}
            </div>
          </div>
        </div>
